...
class Symmetric {
    ...
    private final int GCM_BLOCK_SIZE = 16;
    private final int GCM_TAG_LENGTH_BYTES = 16;
    ...
    Symmetric(int mode, byte[] text, String key) {
